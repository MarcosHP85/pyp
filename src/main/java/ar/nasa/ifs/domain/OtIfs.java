...
@Entity
@Table(name = "ACTIVE_SEPARATE_OVERVIEW", schema = "IFSATA", catalog = "IFSATA")
public class OtIfs {
	...
	public String toString() {
		return "OtIfs [otId=" + otId + ", semanaPlan=" + semanaPlan + ", plantaOt=" + plantaOt + ", orgMant=" + orgMant
				+ ", otMadre=" + otMadre + ", componente=" + componente + ", tarea=" + tarea + ", posicion=" + posicion
				+ ", planifica=" + planifica + ", requierePaqTrabajo=" + requierePaqTrabajo + ", respTarea=" + respTarea
				+ ", estadoOt=" + estadoOt + ", tipoTrabajo=" + tipoTrabajo + ", prioridad=" + prioridad + "]";
	}
